...
class Fettbert(Agent):
    '''Fettbert really has no clue what he's doing...
    
    He distributes troops and attacks countries in a random way. Each round, he attacks exactly one country (if possible) at random.
